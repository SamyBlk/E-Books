...
<section class="display-order">
   ...
   ?>
   <p> <?php echo $fetch_cart['name']; ?> <span>(<?php echo $fetch_cart['price'].' DA '.'/-'.' x '. $fetch_cart['quantity']; ?>)</span> </p>
   <?php
      }
   }else{
   ...
   ?>
   <div class="grand-total"> total : <span><?php echo $grand_total; ?> DA /-</span> </div>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="method">
               ...
               <option value="paytm">paye</option>
            </select>
         </div>
         <div class="inputBox">
